...
public class MyWishListTest extends TestBase {
	...
	public void verifyTheItemIsRemoved() {
		...
		Assert.assertEquals(laptopsAndNotebooksPage.getWishListSuccessBannerText(),
